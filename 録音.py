...
class App:
    ...
    def build_ui(self):
        ...
        queue_log_tab = ttk.Frame(notebook, padding=12)
        notebook.add(record_tab, text="録音")
        notebook.add(queue_log_tab, text="文字起こし / ログ")

        top_frame = ttk.Frame(record_tab)
        ...
        status_frame = ttk.Frame(record_tab)
        ...
        name_frame = ttk.Frame(record_tab, padding=(0, 4))
        ...
        btn_frame = ttk.Frame(record_tab, padding=(0, 12, 0, 0))
        ...
        queue_frame = ttk.LabelFrame(queue_log_tab, text="文字起こしキュー", padding=12)
        queue_frame.pack(fill="both", expand=False, pady=(0, 8))
        ...
        log_frame = ttk.LabelFrame(queue_log_tab, text="ログ", padding=12)
